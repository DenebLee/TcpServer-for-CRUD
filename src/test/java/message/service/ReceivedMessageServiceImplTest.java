...
class ReceivedMessageServiceImplTest extends TestServiceSetUp {
    private final ReceivedMessageServiceImpl receivedMessageService;
    ...
    void should_insert_when_received_quere_have_a_data() throws InsertException, SelectException {
        ...
        DataBaseQueueList dataBaseQueueList = new DataBaseQueueList();
        ...
        // when
        ReceiveMessage result = receivedMessageRepository.findById(1);
        // 한개만 세팅했기에 id는 1
        assertThat(receivedMessageRepository.findById(1)).isNotNull();
